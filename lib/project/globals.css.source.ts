/**
 * Global CSS source for React export
 * This file contains the CSS that will be included in exported React projects
 */

export const globalsCssSource = `@import url("https://fonts.googleapis.com/css2?family=Roboto:ital%2Cwght@0%2C100..900;1%2C100..900&display=swap");
...
/**
 * Get the global CSS source for export
 * @returns The global CSS content as a string
 */
export function getGlobalsCss(): string {
  return globalsCssSource
}
